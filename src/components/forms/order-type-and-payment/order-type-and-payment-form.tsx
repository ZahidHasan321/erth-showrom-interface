...
export function OrderTypeAndPaymentForm({
  ...
  const totalDue = Object.values(charges || {}).reduce((acc, val) => acc + (val || 0), 0);

  React.useEffect(() => {
    if (discountType === 'flat' && discountPercentage) {
      const discount = parseFloat((totalDue * (discountPercentage / 100)).toFixed(2));
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
        ...
        { optional && <div className="rounded-lg border p-4">
              ...
              <FormItem className="space-y-3">
                <FormControl>
                  ...
                  >
                    ...
                    <FormItem className="flex items-center space-x-2">
                      <FormControl>
                        <RadioGroupItem value="homeDelivery" />
                      </FormControl>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <FormItem className="flex items-center space-x-2">
                      <FormControl>
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => field.onChange(checked ? "flat" : undefined)}
                        />
                      </FormControl>
                  ...
                  <div className="flex flex-row justify-center gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <Input type="text" placeholder="discount (in KWD)" {...field} readOnly />
                          </FormControl>
                        </FormItem>
                      )}
                    />
                      ...
                      <FormItem className="flex items-center space-x-2">
                        <FormControl>
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => field.onChange(checked ? "referral" : undefined)}
                          />
                        </FormControl>
                    ...
                    <FormItem className="flex items-center space-x-2">
                      <FormControl>
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => field.onChange(checked ? "loyalty" : undefined)}
                        />
                      </FormControl>
          ...
          <div className="rounded-lg border p-4 space-y-2">
            ...
            {optional && <> <div className="flex justify-between">
