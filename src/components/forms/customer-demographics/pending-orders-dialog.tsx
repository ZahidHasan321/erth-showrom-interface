  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        <ErrorBoundary fallback={<div className="p-4 text-destructive">Failed to load pending orders dialog</div>}>
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              Would you like to continue an existing order or create a new one?
            </DialogDescription>
          </DialogHeader>
